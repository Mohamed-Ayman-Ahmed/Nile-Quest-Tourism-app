...
class Matruh extends StatefulWidget {
  const Matruh({super.key});

  @override
  State<Matruh> createState() => _MatruhState();
}

class _MatruhState extends State<Matruh> {
  ...
  Future<void> fetchUserProfile() async {
    ...
    if (user != null) {
      QuerySnapshot<Map<String, dynamic>> querySnapshot =
          await _firestore.collection('Matruh').get();
