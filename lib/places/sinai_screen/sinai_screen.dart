...
class Sinai extends StatefulWidget {
  const Sinai({super.key});

  @override
  State<Sinai> createState() => _SinaiState();
}

class _SinaiState extends State<Sinai> {
  ...
  Future<void> fetchUserProfile() async {
    ...
    if (user != null) {
      QuerySnapshot<Map<String, dynamic>> querySnapshot =
          await _firestore.collection('south sinai').get();
